...
class Anuncio(models.Model):
    ...
    latitude = models.DecimalField(db_column='Latitude', max_digits=10, decimal_places=0)  # Field name made lowercase.
    longitude = models.DecimalField(db_column='Longitude', max_digits=10, decimal_places=0)  # Field name made lowercase.
